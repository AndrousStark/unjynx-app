...
| Phase 9: v2-Enterprise | PARTIAL (85%) | Web client (39 pages), direct API auth, mobile messaging, wearable pomodoro + content, SSO (SAML/OIDC), SCIM 2.0 provisioning. Remaining: Siri/Google Assistant voice integration |
