...
export default function SignupPage() {
  ...
  // Email registration via backend
  ...
  if (success) {
    return (
      <div className="p-8 text-center">
        ...
        <div className="mx-auto max-w-[200px] h-1 rounded-full bg-[var(--border)] overflow-hidden">
          <div className="h-full w-full rounded-full bg-gradient-to-r from-unjynx-violet to-unjynx-gold animate-[shimmer_1.5s_infinite]" />
        </div>
      </div>
    );
  }
    ...
    <div className="p-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-[var(--muted-foreground)] mt-1.5">
          Start unjynxing your productivity
        </p>
      </div>
      ...
      <button
        ...
        className={cn(
          ...
          'border border-[#dadce0] hover:bg-[#f8f9fa]',
      ...
      <form onSubmit={handleEmailSignup} className="space-y-4">
        {/* Name */}
        <div>
          <label htmlFor="name" className="block text-xs font-medium text-[var(--foreground-secondary)] mb-1.5">
            Full name
          </label>
        ...
        {/* Email */}
        <div>
          <label htmlFor="signup-email" className="block text-xs font-medium text-[var(--foreground-secondary)] mb-1.5">
            Email address
          </label>
          <div className="relative">
        ...
        {/* Password */}
        <div>
          <label htmlFor="signup-password" className="block text-xs font-medium text-[var(--foreground-secondary)] mb-1.5">
            Password
          </label>
          <div className="relative">
