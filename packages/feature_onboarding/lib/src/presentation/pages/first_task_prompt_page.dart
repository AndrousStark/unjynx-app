...
class _FirstTaskPromptPageState extends ConsumerState<FirstTaskPromptPage>
  ...
  void _onTextChanged() {
    ref.read(nlpInputProvider.notifier).state = _textController.text;
  }
  ...
  Future<void> _submit() async {
    ...
    ref.read(firstTaskSubmittingProvider.notifier).state = true;
    ...
    ref.read(firstTaskSubmittingProvider.notifier).state = false;
    ref.read(firstTaskCreatedProvider.notifier).state = true;
