...
class _TodoListPageState extends ConsumerState<TodoListPage> {
  ...
  void _clearFilters() {
    ref.read(todoFilterProvider.notifier).state = const TodoFilter();
    _searchController.clear();
  ...
  void _clearSelection() {
    ref.read(selectedTodoIdsProvider.notifier).state = const {};
  }
...
class _TodoListView extends ConsumerWidget {
  ...
  void _toggleSelection(WidgetRef ref, String id) {
    ...
    ref.read(selectedTodoIdsProvider.notifier).state = updated;
    HapticFeedback.selectionClick();
  }

  void _enterBulkMode(WidgetRef ref, String id) {
    ref.read(selectedTodoIdsProvider.notifier).state = {id};
